...
func (c *EmbedMDToOpenAPIConverterImpl) ConvertDocArtifact(source *models.BaseEntity[models.DocArtifactAttributes]) (*openapi.DocArtifact, error) {
	...
	if source != nil {
		...
		openapiDocArtifact.Owner = converter.MapEmbedMDOwner((*source).Properties)
		openapiDocArtifact.UserId = converter.MapEmbedMDUserId((*source).Properties)
...
func (c *EmbedMDToOpenAPIConverterImpl) ConvertInferenceService(source *models.BaseEntity[models.InferenceServiceAttributes]) (*openapi.InferenceService, error) {
	...
	if source != nil {
		...
		openapiInferenceService.Owner = converter.MapEmbedMDOwner((*source).Properties)
		openapiInferenceService.UserId = converter.MapEmbedMDUserId((*source).Properties)
...
func (c *EmbedMDToOpenAPIConverterImpl) ConvertModelArtifact(source *models.BaseEntity[models.ModelArtifactAttributes]) (*openapi.ModelArtifact, error) {
	...
	if source != nil {
		...
		openapiModelArtifact.Owner = converter.MapEmbedMDOwner((*source).Properties)
		openapiModelArtifact.UserId = converter.MapEmbedMDUserId((*source).Properties)
...
func (c *EmbedMDToOpenAPIConverterImpl) ConvertModelVersion(source *models.BaseEntity[models.ModelVersionAttributes]) (*openapi.ModelVersion, error) {
	...
	if source != nil {
		...
		openapiModelVersion.Owner = converter.MapEmbedMDOwner((*source).Properties)
		openapiModelVersion.UserId = converter.MapEmbedMDUserId((*source).Properties)
...
func (c *EmbedMDToOpenAPIConverterImpl) ConvertRegisteredModel(source *models.BaseEntity[models.RegisteredModelAttributes]) (*openapi.RegisteredModel, error) {
	...
	if source != nil {
		...
		openapiRegisteredModel.UserId = converter.MapEmbedMDUserId((*source).Properties)
...
func (c *EmbedMDToOpenAPIConverterImpl) ConvertServeModel(source *models.BaseEntity[models.ServeModelAttributes]) (*openapi.ServeModel, error) {
	...
	if source != nil {
		...
		openapiServeModel.Owner = converter.MapEmbedMDOwner((*source).Properties)
		openapiServeModel.UserId = converter.MapEmbedMDUserId((*source).Properties)
...
func (c *EmbedMDToOpenAPIConverterImpl) ConvertServingEnvironment(source *models.BaseEntity[models.ServingEnvironmentAttributes]) (*openapi.ServingEnvironment, error) {
	...
	if source != nil {
		...
		openapiServingEnvironment.Owner = converter.MapEmbedMDOwner((*source).Properties)
		openapiServingEnvironment.UserId = converter.MapEmbedMDUserId((*source).Properties)
