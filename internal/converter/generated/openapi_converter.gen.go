...
func (c *OpenAPIConverterImpl) ConvertDocArtifactCreate(source *openapi.DocArtifactCreate) (*openapi.DocArtifact, error) {
	...
	if source != nil {
		...
		if (*source).Owner != nil {
			...
			openapiDocArtifact.Owner = &xstring4
		}
		if (*source).UserId != nil {
			xstring5 := *(*source).UserId
			openapiDocArtifact.UserId = &xstring5
		}
		if (*source).Uri != nil {
			xstring6 := *(*source).Uri
			openapiDocArtifact.Uri = &xstring6
		}
		if (*source).State != nil {
...
func (c *OpenAPIConverterImpl) ConvertInferenceServiceCreate(source *openapi.InferenceServiceCreate) (*openapi.InferenceService, error) {
	...
	if source != nil {
		...
		if (*source).Owner != nil {
			xstring4 := *(*source).Owner
			openapiInferenceService.Owner = &xstring4
		}
		if (*source).UserId != nil {
			xstring5 := *(*source).UserId
			openapiInferenceService.UserId = &xstring5
		}
		if (*source).ModelVersionId != nil {
			xstring6 := *(*source).ModelVersionId
			openapiInferenceService.ModelVersionId = &xstring6
		}
		if (*source).Runtime != nil {
			xstring7 := *(*source).Runtime
			openapiInferenceService.Runtime = &xstring7
		}
...
func (c *OpenAPIConverterImpl) ConvertInferenceServiceUpdate(source *openapi.InferenceServiceUpdate) (*openapi.InferenceService, error) {
	...
	if source != nil {
		...
		if (*source).ModelVersionId != nil {
			xstring5 := *(*source).ModelVersionId
...
func (c *OpenAPIConverterImpl) ConvertModelArtifactCreate(source *openapi.ModelArtifactCreate) (*openapi.ModelArtifact, error) {
	...
	if source != nil {
		...
		if (*source).Owner != nil {
			xstring4 := *(*source).Owner
			openapiModelArtifact.Owner = &xstring4
		}
		if (*source).UserId != nil {
			xstring5 := *(*source).UserId
			openapiModelArtifact.UserId = &xstring5
		}
		if (*source).ModelFormatName != nil {
			xstring6 := *(*source).ModelFormatName
			openapiModelArtifact.ModelFormatName = &xstring6
		}
		if (*source).StorageKey != nil {
			xstring7 := *(*source).StorageKey
			openapiModelArtifact.StorageKey = &xstring7
		}
		if (*source).StoragePath != nil {
			xstring8 := *(*source).StoragePath
			openapiModelArtifact.StoragePath = &xstring8
		}
		if (*source).ModelFormatVersion != nil {
			xstring9 := *(*source).ModelFormatVersion
			openapiModelArtifact.ModelFormatVersion = &xstring9
		}
		if (*source).ServiceAccountName != nil {
			xstring10 := *(*source).ServiceAccountName
			openapiModelArtifact.ServiceAccountName = &xstring10
		}
		if (*source).ModelSourceKind != nil {
			xstring11 := *(*source).ModelSourceKind
			openapiModelArtifact.ModelSourceKind = &xstring11
		}
		if (*source).ModelSourceClass != nil {
			xstring12 := *(*source).ModelSourceClass
			openapiModelArtifact.ModelSourceClass = &xstring12
		}
		if (*source).ModelSourceGroup != nil {
			xstring13 := *(*source).ModelSourceGroup
			openapiModelArtifact.ModelSourceGroup = &xstring13
		}
		if (*source).ModelSourceId != nil {
			xstring14 := *(*source).ModelSourceId
			openapiModelArtifact.ModelSourceId = &xstring14
		}
		if (*source).ModelSourceName != nil {
			xstring15 := *(*source).ModelSourceName
			openapiModelArtifact.ModelSourceName = &xstring15
		}
		if (*source).Uri != nil {
			xstring16 := *(*source).Uri
			openapiModelArtifact.Uri = &xstring16
		}
		if (*source).State != nil {
			openapiArtifactState, err := c.openapiArtifactStateToOpenapiArtifactState(*(*source).State)
			if err != nil {
...
func (c *OpenAPIConverterImpl) ConvertServeModelCreate(source *openapi.ServeModelCreate) (*openapi.ServeModel, error) {
	...
	if source != nil {
		...
		if (*source).Owner != nil {
			xstring4 := *(*source).Owner
			openapiServeModel.Owner = &xstring4
		}
		if (*source).UserId != nil {
			xstring5 := *(*source).UserId
			openapiServeModel.UserId = &xstring5
		}
