...
func (c *MLMDToOpenAPIConverterImpl) ConvertDocArtifact(source *proto.Artifact) (*openapi.DocArtifact, error) {
	...
	if source != nil {
		...
		openapiDocArtifact.Owner = converter.MapOwner((*source).Properties)
		openapiDocArtifact.UserId = converter.MapUserId((*source).Properties)
...
func (c *MLMDToOpenAPIConverterImpl) ConvertInferenceService(source *proto.Context) (*openapi.InferenceService, error) {
	...
	if source != nil {
		...
		openapiInferenceService.Owner = converter.MapOwner((*source).Properties)
		openapiInferenceService.UserId = converter.MapUserId((*source).Properties)
...
func (c *MLMDToOpenAPIConverterImpl) ConvertModelArtifact(source *proto.Artifact) (*openapi.ModelArtifact, error) {
	...
	if source != nil {
		...
		openapiModelArtifact.Owner = converter.MapOwner((*source).Properties)
		openapiModelArtifact.UserId = converter.MapUserId((*source).Properties)
...
func (c *MLMDToOpenAPIConverterImpl) ConvertModelVersion(source *proto.Context) (*openapi.ModelVersion, error) {
	...
	if source != nil {
		...
		openapiModelVersion.Owner = converter.MapOwner((*source).Properties)
		openapiModelVersion.UserId = converter.MapUserId((*source).Properties)
...
func (c *MLMDToOpenAPIConverterImpl) ConvertRegisteredModel(source *proto.Context) (*openapi.RegisteredModel, error) {
	...
	if source != nil {
		...
		openapiRegisteredModel.UserId = converter.MapUserId((*source).Properties)
...
func (c *MLMDToOpenAPIConverterImpl) ConvertServeModel(source *proto.Execution) (*openapi.ServeModel, error) {
	...
	if source != nil {
		...
		openapiServeModel.Owner = converter.MapOwner((*source).Properties)
		openapiServeModel.UserId = converter.MapUserId((*source).Properties)
...
func (c *MLMDToOpenAPIConverterImpl) ConvertServingEnvironment(source *proto.Context) (*openapi.ServingEnvironment, error) {
	...
	if source != nil {
		...
		openapiServingEnvironment.Owner = converter.MapOwner((*source).Properties)
		openapiServingEnvironment.UserId = converter.MapUserId((*source).Properties)
