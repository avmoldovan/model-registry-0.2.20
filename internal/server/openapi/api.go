...
type ModelRegistryServiceAPIServicer interface {
	...
	FindArtifact(context.Context, string, string, string, string, string) (ImplResponse, error)
	FindInferenceService(context.Context, string, string, string, string, string) (ImplResponse, error)
	FindModelArtifact(context.Context, string, string, string, string, string) (ImplResponse, error)
	FindModelVersion(context.Context, string, string, string, string, string) (ImplResponse, error)
	FindRegisteredModel(context.Context, string, string, string, string) (ImplResponse, error)
	FindServingEnvironment(context.Context, string, string, string, string) (ImplResponse, error)
	GetArtifact(context.Context, string, string, string) (ImplResponse, error)
	GetArtifacts(context.Context, string, string, model.OrderByField, model.SortOrder, string, string) (ImplResponse, error)
	GetEnvironmentInferenceServices(context.Context, string, string, string, string, string, model.OrderByField, model.SortOrder, string, string) (ImplResponse, error)
	GetInferenceService(context.Context, string, string, string) (ImplResponse, error)
	GetInferenceServiceModel(context.Context, string, string, string) (ImplResponse, error)
	GetInferenceServiceServes(context.Context, string, string, string, string, string, model.OrderByField, model.SortOrder, string, string) (ImplResponse, error)
	GetInferenceServiceVersion(context.Context, string, string, string) (ImplResponse, error)
	GetInferenceServices(context.Context, string, string, model.OrderByField, model.SortOrder, string, string) (ImplResponse, error)
	GetModelArtifact(context.Context, string, string, string) (ImplResponse, error)
	GetModelArtifacts(context.Context, string, string, model.OrderByField, model.SortOrder, string, string) (ImplResponse, error)
	GetModelVersion(context.Context, string, string, string) (ImplResponse, error)
	GetModelVersionArtifacts(context.Context, string, string, string, string, string, model.OrderByField, model.SortOrder, string, string) (ImplResponse, error)
	GetModelVersions(context.Context, string, string, model.OrderByField, model.SortOrder, string, string) (ImplResponse, error)
	GetRegisteredModel(context.Context, string, string, string) (ImplResponse, error)
	GetRegisteredModelVersions(context.Context, string, string, string, string, string, model.OrderByField, model.SortOrder, string, string) (ImplResponse, error)
	GetRegisteredModels(context.Context, string, string, model.OrderByField, model.SortOrder, string, string) (ImplResponse, error)
	GetServingEnvironment(context.Context, string, string, string) (ImplResponse, error)
	GetServingEnvironments(context.Context, string, string, model.OrderByField, model.SortOrder, string, string) (ImplResponse, error)
