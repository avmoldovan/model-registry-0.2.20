...
func (o *RegisteredModelUpdate) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *RegisteredModelUpdate) GetUserIdOk() (*string, bool) {
	if o == nil || IsNil(o.UserId) {
		return nil, false
	}
...
func (o *RegisteredModelUpdate) HasUserId() bool {
	if o != nil && !IsNil(o.UserId) {
		return true
	}
...
func (o *RegisteredModelUpdate) SetUserId(v string) {
	o.UserId = &v
}
