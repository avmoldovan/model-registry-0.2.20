...
func (o *RegisteredModel) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *RegisteredModel) GetUserIdOk() (*string, bool) {
	if o == nil || IsNil(o.UserId) {
		return nil, false
	}
...
func (o *RegisteredModel) HasUserId() bool {
	if o != nil && !IsNil(o.UserId) {
		return true
	}
...
func (o *RegisteredModel) SetUserId(v string) {
	o.UserId = &v
}
