...
func (o *RegisteredModelCreate) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *RegisteredModelCreate) GetUserIdOk() (*string, bool) {
	if o == nil || IsNil(o.UserId) {
		return nil, false
	}
...
func (o *RegisteredModelCreate) HasUserId() bool {
	if o != nil && !IsNil(o.UserId) {
		return true
	}
...
func (o *RegisteredModelCreate) SetUserId(v string) {
	o.UserId = &v
}
