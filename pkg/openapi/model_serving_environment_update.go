...
type ServingEnvironmentUpdate struct {
	...
	// The client provided owner of the artifact. This field is required.
	Owner *string `json:"owner,omitempty"`
	// The client provided user identifier of the artifact. This field is required.
...
func (o *ServingEnvironmentUpdate) GetOwner() string {
...
// and a boolean to check if the value has been set.
func (o *ServingEnvironmentUpdate) GetOwnerOk() (*string, bool) {
	if o == nil || IsNil(o.Owner) {
		return nil, false
	}
	return o.Owner, true
...
func (o *ServingEnvironmentUpdate) HasOwner() bool {
	if o != nil && !IsNil(o.Owner) {
		return true
	}
...
func (o *ServingEnvironmentUpdate) SetOwner(v string) {
	o.Owner = &v
}

// GetUserId returns the UserId field value if set, zero value otherwise.
func (o *ServingEnvironmentUpdate) GetUserId() string {
...
// and a boolean to check if the value has been set.
func (o *ServingEnvironmentUpdate) GetUserIdOk() (*string, bool) {
	if o == nil || IsNil(o.UserId) {
		return nil, false
	}
...
func (o *ServingEnvironmentUpdate) HasUserId() bool {
	if o != nil && !IsNil(o.UserId) {
		return true
	}
...
func (o *ServingEnvironmentUpdate) SetUserId(v string) {
	o.UserId = &v
}
